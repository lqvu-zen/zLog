...
def build_menus(win) -> None:
    ...
    search_all_tabs_act = view_menu.addAction("Search All &Tabs…")
    search_all_tabs_act.setShortcut("Ctrl+Shift+F")
    search_all_tabs_act.triggered.connect(win._search_all_tabs)
